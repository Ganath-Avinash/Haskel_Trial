...
/* package HaskelTrial-0.1.0.0 */
#ifndef VERSION_HaskelTrial
#define VERSION_HaskelTrial "0.1.0.0"
#endif /* VERSION_HaskelTrial */
#ifndef MIN_VERSION_HaskelTrial
#define MIN_VERSION_HaskelTrial(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskelTrial */
...
#define CURRENT_COMPONENT_ID "HaskelTrial-0.1.0.0-inplace-HaskelTrial"
